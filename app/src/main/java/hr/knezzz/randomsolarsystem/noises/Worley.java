...
public class Worley extends NoiseSource{
	...
	private final double DENSITY_ADJUSTMENT = 0.398150;
	private final double INV_DENSITY_ADJUSTMENT = 1.0/0.398150;

	// The main function!
	public void noise(double at[], int max_order, double F[],
	                         double delta[][], int ID[])
	{
...
*/
	...
	private void AddSamples(int xi, int yi, int zi, int max_order,
	                               double at[], double F[],
	                               double delta[][], int ID[])
	{
